        ...
        <div class="navbar-header">
            ...
            <ol class="breadcrumb hidden-xs">
                ...
                <?php if(count($segments) == 0): ?>
                    <li class="active"><i class="voyager-home mr-1"></i> <?php echo e(__('Admin')); ?></li>
                <?php else: ?>
                    <li class="active">
                        <a href="<?php echo e(route('voyager.dashboard')); ?>"><i class="voyager-home mr-1"></i> <?php echo e(__('Admin')); ?></a>
                    </li>
...
<?php /**PATH /home/u828667958/domains/vitrinsx.com/public_html/resources/views/vendor/voyager/dashboard/navbar.blade.php ENDPATH**/ ?>