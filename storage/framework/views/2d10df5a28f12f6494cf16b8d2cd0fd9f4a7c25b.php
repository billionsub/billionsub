<?php $__env->startSection('page_title', __('Register')); ?>

<?php $__env->startSection('page_description', getSetting('site.description')); ?>
<?php $__env->startSection('share_url', route('home')); ?>
<?php $__env->startSection('share_title', getSetting('site.name') . ' - ' .  __('Register')); ?>
...
<?php echo $__env->make('layouts.no-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u828667958/domains/vitrinsx.com/public_html/resources/views/auth/register.blade.php ENDPATH**/ ?>