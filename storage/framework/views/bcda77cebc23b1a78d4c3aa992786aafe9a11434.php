            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <?php if($dataType->slug == 'user-verifies'): ?>
                            <div class="identity-files-preview">
                            <?php $__currentLoopData = $dataType->editRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($row->field == 'files' && $dataTypeContent->{$row->field}): ?>
                                    <label class="control-label"><?php echo e(__("Identification images preview")); ?></label>
                                    <div>
                                        <?php $__currentLoopData = json_decode($dataTypeContent->{$row->field}); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php echo $__env->make('vendor.voyager.partials.voyager-file-preview-box', ['asset' => $row], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <?php if(count($errors) > 0): ?>
                            ...
                            <?php $__currentLoopData = $dataTypeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if(isset($row->details->legend) && isset($row->details->legend->text)): ?>
                                    <legend class="bread-label text-<?php echo e($row->details->legend->align ?? 'center'); ?>" style="background-color: <?php echo e($row->details->legend->bgcolor ?? '#f0f0f0'); ?>;"><?php echo e($row->details->legend->text); ?></legend>
                                <?php endif; ?>
                                ...
                                <div class="form-group <?php if($row->type == 'hidden'): ?> hidden <?php endif; ?> col-md-<?php echo e($display_options->width ?? 12); ?> <?php echo e($errors->has($row->field) ? 'has-error' : ''); ?>" <?php if(isset($display_options->id)): ?><?php echo e("id=$display_options->id"); ?><?php endif; ?>>
                                    ...
                                    <?php elseif($row->type == 'relationship'): ?>
                                        <?php echo $__env->make('vendor.voyager.bread.relationship', ['options' => $row->details], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php else: ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/public_html/resources/views/vendor/voyager/bread/edit-add.blade.php ENDPATH**/ ?>