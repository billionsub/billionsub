        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="" style="padding-bottom:5px;">
                    ...
                    <?php if($dataType->slug == 'attachments'): ?>
                        <div class="">
                            <?php $__currentLoopData = $dataType->editRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($row->field == 'filename' && $dataTypeContent->{$row->field}): ?>
                                    <h3 class="panel-title pl-0"><?php echo e(__("Attachment preview")); ?></h3>
                                    <div class="identity-files-preview">
                                        <?php echo $__env->make('vendor.voyager.partials.voyager-file-preview-box', ['asset' => $dataTypeContent->{$row->field}, 'attachment' => $dataTypeContent], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $dataType->readRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            <?php elseif($row->type == 'relationship'): ?>
                                <?php echo $__env->make('vendor.voyager.bread.relationship', ['view' => 'read', 'options' => $row->details], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u828667958/domains/vitrinsx.com/public_html/resources/views/vendor/voyager/bread/read.blade.php ENDPATH**/ ?>