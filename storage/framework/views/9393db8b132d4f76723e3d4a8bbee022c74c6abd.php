<nav class="navbar navbar-expand-md <?php echo e((Cookie::get('app_theme') == null ? (getSetting('site.default_user_theme') == 'dark' ? 'navbar-dark bg-dark' : 'navbar-light bg-white') : (Cookie::get('app_theme') == 'dark' ? 'navbar-dark bg-dark' : 'navbar-light bg-white'))); ?> shadow-sm ">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            <img src="<?php echo e(asset( (Cookie::get('app_theme') == null ? (getSetting('site.default_user_theme') == 'dark' ? getSetting('site.dark_logo') : getSetting('site.light_logo')) : (Cookie::get('app_theme') == 'dark' ? getSetting('site.dark_logo') : getSetting('site.light_logo'))) )); ?>" style="height: 75px; width: 65px; object-fit: cover" class="d-inline-block align-top mr-1 ml-3" alt="<?php echo e(__("Site logo")); ?>">
        </a>
                ...
                <?php else: ?>
                    <li class="nav-item dropdown">
                        <a id="navbarDropdown" class="nav-link dropdown-toggle text-right text-truncate d-flex align-items-center" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="text-truncate max-width-150 mr-1"><?php echo e(Auth::user()->name); ?></div>
                            <img src="<?php echo e(Auth::user()->avatar); ?>" class="rounded-circle home-user-avatar">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('my.messenger.get')); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/public_html/resources/views/template/header.blade.php ENDPATH**/ ?>