        ...
        return $schema->components([
                Section::make()
                    ...
                    ->schema([
                        ...
                        TextInput::make('pushr_cdn_hostname')->label('Pushr CDN Hostname')->visible(fn ($get) => $get('driver') === 'pushr')->required()->helperText('This field must contain the https:// prefix.'),
